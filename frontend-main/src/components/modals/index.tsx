                    ...
                    buttons ? (
                        <div className="buttons">
                            ...
                            {buttons[1] ? buttonsHref[1] ? (
                                <Link to={buttonsHref[1]} onClick={() => onClick(navPage, setNavPage)}>
                                    <Button loader={buttonLoader} name={buttons[1]} disabled={buttonsBlock} onClick={() => onClick(navPage, setNavPage)} />
                                </Link>
                            ) :
                                (<Button loader={buttonLoader} name={buttons[1]} disabled={buttonsBlock} onClick={() => onClick(navPage, setNavPage)} />)
                            : ''}
