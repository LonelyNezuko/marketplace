...
import './index.scss'
import { CircleLoader, CircleLoaderType } from "@components/circleLoader/circleLoader";
        ...
        >
            ...
            {loader && (
                <div className="buttonLoader">
                    <CircleLoader type={loaderType || size === 'min' ? 'min' : null} />
                </div>
            )}
        </button>
    )
