                ...
                <div className="rightblock">
                    <section className="topsection">
                        <div className="titleblock">
                            ...
                            <Link target={"_blank"} to={categoryGenerateLink(product.prodCategory)} className="categoryname">{product.prodCategory.categoryName}</Link>
                        </div>
                        <PriceBlock />
                        <span className="desc" dangerouslySetInnerHTML={{__html: formatText(product.prodDescription, 50)}}></span>
                    </section>
        ...
        <section className="previewWrapper" onMouseLeave={() => setPreviewSelect(0)} {...swipeImages}>
            <div className="previewImages" style={{transform: `translateX(-${previewSelect * 100}%)`}}>
                {product.prodImages.map((item, i) => {
                    ...
                    return (
                        <section key={i}>
                            <img className="privewimage" src={formatImage(item, 360)} />
